...
package cn.edu.sjtu.se.lingSun;
...
public class FindBadForLoopScala extends OpcodeStackDetector implements StatelessDetector {

    BugReporter bugReporter;

    public FindBadForLoopScala(BugReporter bugReporter) {
